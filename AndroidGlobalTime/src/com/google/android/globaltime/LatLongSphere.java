...
public class LatLongSphere extends Sphere {
    ...
    public LatLongSphere(float centerX, float centerY, float centerZ,
            float radius, int lats, int longs, float minLongitude,
            float maxLongitude, boolean emitTextureCoordinates,
            boolean emitNormals, boolean emitColors, boolean flatten) {
        ...
        for (int i = 0; i < longs; i++) {
            ...
            float theta = (maxLongitude - minLongitude) * (1.0f - fi)
                    + minLongitude;
